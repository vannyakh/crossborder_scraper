import { Button, Field, Grid, HStack, IconButton, Input, Text, VStack } from '@chakra-ui/react'
...
export function DatabaseAddDialog({
  ...
  return (
    <PanelDialog open={open} onClose={onClose} title={t('db.create.title')} footer={footer}>
      <VStack align="stretch" gap={4}>
        ...
        <Field.Root>
          ...
          <PanelSelect
            ...
            disabled={!open}
            zIndex={1600}
            onChange={(access) => patch({ access: access as DatabaseCreateDraft['access'] })}
          />
        </Field.Root>
