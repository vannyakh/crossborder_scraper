"""ScrapeManager facade — single entry for gateway tools, scheduler, and CLI."""
...
class ScrapeManager:
    """Delegates to domain services; keeps gateway/CLI imports stable."""
    ...
    async def cancel_batch(self, batch_id: str) -> bool:
        return get_batch_service().cancel_batch(batch_id)
